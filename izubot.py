...
BOT_DISPLAY_NAME = "zero ᴘʀᴇᴍɪᴜᴍ sᴇᴀʀᴄʜᴇʀ"
    ...
    if is_at_least_role(user_id, "owner"):
        ...
        welcome_msg = (
         ...
         welcome_msg = (
            ...
            "For any assistance, please contact: @krzero00"
        )
        ...
        welcome_msg = (
            ...
            "Need premium access? Contact: @krzero00"
        )
...
async def handle_enter_key(update: Update, context: CallbackContext):
    ...
    if key in ACCESS_KEYS:
        ...
        await update.message.reply_text(
            ...
            "🆕 **ɢᴇᴛ ɴᴇᴡ ᴀᴄᴄᴇss**\n"
            "ᴄᴏɴᴛᴀᴄᴛ: @krzero00 ғᴏʀ ᴀ ɴᴇᴡ ᴘʀᴇᴍɪᴜᴍ ᴋᴇʏ.",
            parse_mode="Markdown"
        )
        AWAITING_KEY_INPUT.discard(user_id)
    else:
        await update.message.reply_text(
            ...
            "👨💻 **sᴜᴘᴘᴏʀᴛ**\n"
            "ᴄᴏɴᴛᴀᴄᴛ: @krzero00 ғᴏʀ ᴀssɪsᴛᴀɴᴄᴇ.",
            parse_mode="Markdown"
        )
...
async def prompt_for_key(update: Update, context: CallbackContext):
    ...
    message_text = (
        ...
        "`zeropremium-abc789`\n\n"
        "🔓 **ɴᴇᴇᴅ ᴀᴄᴄᴇss?**\n"
        "ᴄᴏɴᴛᴀᴄᴛ @krzero00 ᴛᴏ ᴀᴄǫᴜɪʀᴇ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴋᴇʏ."
    )
...
async def show_help(update: Update, context: CallbackContext):
    ...
    help_text = (
        ...
        "➢ ᴏʙᴛᴀɪɴ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇss ᴋᴇʏ ғʀᴏᴍ **@krzero00**.\n"
        ...
        "⌫ ғᴏʀ ᴀɴʏ ғᴜʀᴛʜᴇʀ sᴜᴘᴘᴏʀᴛ ᴏʀ ɪɴǫᴜɪʀɪᴇs, ᴘʟᴇᴀsᴇ ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ ᴀᴅᴍɪɴɪsᴛʀᴀᴛᴏʀ **@krzero00**."
    )
    keyboard = [[InlineKeyboardButton("⬅️ ʙᴀᴄᴋ ᴛᴏ ᴍᴀɪɴ ᴍᴇɴᴜ", callback_data="back_to_main_menu")]]
    reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    if not has_access(user_id):
        if update.callback_query:
            ...
            await current_message.edit_text(
                ...
                "You need active premium access to use the Python Encryptor. Please use an access key or contact @krzero00 to purchase access.",
                parse_mode="Markdown"
            )
        else:
            await current_message.reply_text(
...
async def datadome_info(update: Update, context: CallbackContext):
    ...
    await current_message.edit_text(
        ...
        "For technical support: @krzero00",
        parse_mode="Markdown",
        reply_markup=InlineKeyboardMarkup([
